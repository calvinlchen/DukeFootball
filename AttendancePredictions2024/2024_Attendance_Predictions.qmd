...
late_jan_pred_lm_merge <- linear_reg() |>
  set_engine("lm") |>
  fit(AttNum ~ Cutcliffe * OppFPI_PrevYear *
        First_Game * OppRankedGametime * log(OppCityDist) +
        FPI_Diff_PrevYear + Renovated + UNC_Game + Day,
      data = home_att_data_2)
...
late_jan_pred_lm_merge_noFPI <- linear_reg() |>
  ...
  fit(AttNum ~ Cutcliffe * First_Game * 
        ...
        Renovated + UNC_Game + Day + Win_Streak,
      data = home_att_data_2)
...
late_jan_pred_model_data |>
  ...
  labs(title = "2024-Season Attendance Predictions (version 4)",
